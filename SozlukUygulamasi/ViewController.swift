...
class ViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let gidilecekViewController = segue.destination as! KelimeDetayViewController;
        
        gidilecekViewController.kelime = kelimeListesi[indeks!];
    }

    func tumKelimelerAl() {
       
        let url = URL(string: "http://aodurmaz.xyz/sozluk/tum_kelimeler.php")!;
    ...
    func aramaYap(aramaKelimesi:String) {
        ...
        var request = URLRequest(url: URL(string: "http://aodurmaz.xyz/sozluk/kelime_ara.php")!);
